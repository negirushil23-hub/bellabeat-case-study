...
- **Relocated headers**: the March-April `heartrate_seconds_merged.csv` and
  both months' `weightLogInfo_merged.csv` were found with their header row
  at the *last* line of the file instead of the first. Handled automatically.
